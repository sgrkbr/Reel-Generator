...
**初版キーフレーム** (nano_banana_pro / 2D, 9:16, 2026-06-06):
- Mei: `92459174-6aa0-4b79-94e5-8bc43d4734a9` ✅ 採用
- Sam: `31908049-77f3-4aa7-b411-6bee3f2ce370` ✅ 採用
- Pair v1 (text-only, living room): `eefcffc1-9237-4013-b9fe-282ab184cc20` ❌ 一貫性不足
- Pair v2 (Mei/Sam reference 注入): `aff2b692-5f48-4b97-a5dd-c0eedb649c33` ✅ 採用候補

**重要**: ペアショットや他シーン展開では **必ず Mei / Sam の単体画像を `medias[role:image]` として参照** に渡す。text-only では同一人物が再現できない。
